...
public class CodeSettingActivity extends AppCompatActivity {
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(result)){
                    Toast.makeText(CodeSettingActivity.this, result, Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(CodeSettingActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
